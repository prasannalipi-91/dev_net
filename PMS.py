...
file = open('D:/MMC-HC/PMS_ACTIVITY/pms_input.csv','r')
file1 = open('D:/MMC-HC/PMS_ACTIVITY/pms_config_log,txt','w') ## need to change with a proper name
...
def commandset(count):
    ...
    command_array.append("description :: Access Port Connected To PMS " + x[3].strip() + " ::")
    command_array.append("switchport access vlan 2060")
