...
file = open('D:/MMC-HC/BMS_PDU/PDU_input3.csv','r')
file1 = open('D:/MMC-HC/BMS_PDU/bms-pdu-config-change-ics.txt','w') ## need to change with a proper name
...
def commandset(count):
    ...
    command_array.append("description :: Access Port Connected To ICS " + x[2].strip() + " ::")
