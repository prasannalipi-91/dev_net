...
file = open('D:/MMC-HC/HC_UNUSED/up_ews.csv','r')
file1 = open('D:/MMC-HC/HC_UNUSED/port_up_ews_log.txt','w') ## need to change with a proper name
...
#        print(commandset(count1))
        ...
        net_connect.enable()
        print("unshutting down ports on : " + x[1])
