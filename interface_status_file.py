...
file = open('D:/MMC-CCTV/B02-03-04to09-ext/hc_port_status.txt', 'r')
file1 = open('D:/MMC-CCTV/B02-03-04to09-ext/hc_port_status_edited.txt', 'w')
...
with open('D:/MMC-CCTV/B02-03-04to09-ext/hc_port_status_edited.txt','r') as file:
...
file = open('D:/MMC-CCTV/B02-03-04to09-ext/port_status_file.csv', 'r')
file1 = open('D:/MMC-CCTV/B02-03-04to09-ext/port_status_file1.csv', 'w')
...
os.remove('D:/MMC-CCTV/B02-03-04to09-ext/port_status_file.csv')
os.remove('D:/MMC-CCTV/B02-03-04to09-ext/hc_port_status_edited.txt')
